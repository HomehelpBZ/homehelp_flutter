...
class _Step1PersonalState extends State<Step1Personal> {
  ...
  Future<void> _pickPhoto() async {
    ...
    if (image != null) {
      ...
      setState(() { _photo = image; _photoBytes = bytes; });
    }
  }
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                          ...
                          child: _photoBytes == null
                              ? Column(
                                  ...
                                  children: const [
                                    ...
                                    Text('Upload', style: TextStyle(color: Colors.white, fontSize: 9)),
                                  ],
                                )
                              : null,
                        ),
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(s.faceVisible, style: const TextStyle(fontSize: 11, color: AppTheme.grey600)),
                          if (_photo != null) ...[
                            const SizedBox(height: 5),
                            Row(children: [
                              const Icon(Icons.check_circle, size: 13, color: AppTheme.primary),
                              const SizedBox(width: 4),
                              Text(s.photoUploaded, style: const TextStyle(fontSize: 11, color: AppTheme.primary)),
                            ]),
                          ],
                        ],
                      ),
                  ...
                  Text(s.phoneNote, style: const TextStyle(fontSize: 11, color: AppTheme.grey400)),
                  const SizedBox(height: 14),
                  SectionLabel(s.placeOfBirth),
                  DropdownButtonFormField<String>(
                    value: _selectedRegion,
                    hint: Text(s.selectRegion, style: const TextStyle(fontSize: 13, color: AppTheme.grey400)),
                    ...
                    items: s.regions.map((r) => DropdownMenuItem(value: r,
                        child: Text(r, style: const TextStyle(fontSize: 13)))).toList(),
                  ...
                  DropdownButtonFormField<String>(
                    value: _selectedAge,
                    hint: Text(s.selectAgeRange, style: const TextStyle(fontSize: 13, color: AppTheme.grey400)),
                    decoration: InputDecoration(
                      filled: true, fillColor: Colors.white,
                      border: OutlineInputBorder(borderRadius: BorderRadius.circular(8),
                          borderSide: const BorderSide(color: Color(0xFFE0E0E0), width: 0.5)),
                    ...
                    items: s.ageRanges.map((a) => DropdownMenuItem(value: a,
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    hint: Text(s.selectGender, style: const TextStyle(fontSize: 13, color: AppTheme.grey400)),
                    decoration: InputDecoration(
                      filled: true, fillColor: Colors.white,
                      border: OutlineInputBorder(borderRadius: BorderRadius.circular(8),
                          borderSide: const BorderSide(color: Color(0xFFE0E0E0), width: 0.5)),
                    ...
                    items: [s.female, s.male].map((g) => DropdownMenuItem(value: g,
                        child: Text(g, style: const TextStyle(fontSize: 13)))).toList(),
                  ...
                  PrimaryButton(
                    label: s.continueBtn,
                    onPressed: _isValid
                        ? () => Navigator.push(context, MaterialPageRoute(builder: (_) => const Step2Background()))
                        : null,
                  ),
                  const SizedBox(height: 16),
                ],
