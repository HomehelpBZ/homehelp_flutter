...
// ── Landing screen ────────────────────────────────────────────────────────────
class FamilyAuthScreen extends StatelessWidget {
                  ...
                  children: [
                        ...
                        child: Row(children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(s.browseWithoutAccount,
                                    style: const TextStyle(
                                        fontSize: 14,
                                        fontWeight: FontWeight.w500,
                                        color: AppTheme.grey800)),
                                const SizedBox(height: 2),
                                Text(s.welcomeHireSubtitle,
                                    style: const TextStyle(
                                        fontSize: 11,
                    ...
                    GestureDetector(
                      onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (_) => const _FamilySignUpScreen()),
                      ),
                      child: Container(
                        width: double.infinity,
                        padding: const EdgeInsets.all(16),
...
// ── Sign Up Screen ────────────────────────────────────────────────────────────
class _FamilySignUpScreen extends StatefulWidget {
  const _FamilySignUpScreen();

  @override
  State<_FamilySignUpScreen> createState() => _FamilySignUpScreenState();
}

class _FamilySignUpScreenState extends State<_FamilySignUpScreen> {
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (_) => OtpScreen(
                ...
                isHousekeeper: false,
                onSuccess: () => const FamilyHomeScreen(isGuest: false),
              ),
            ),
          );
        }
            ...
            child: SafeArea(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Create your free HomeHelp account',
                      style: const TextStyle(
    ...
    try {
      ...
      if (mounted) {
        Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(
              builder: (_) => const FamilyHomeScreen(isGuest: false)),
          (r) => false,
        );
      }
    } catch (e) {
